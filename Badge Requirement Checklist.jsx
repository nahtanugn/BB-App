...
const seedBadges = [
  // Compulsory
    ...
    level: "Basic",
    requirements: [
      req("Attend Target class / sessions for the term"),
      req("Complete the term's Target assignment"),
      req("Take part in Target assesment"),
    ],
  },
  {
    id: uid("b"),
  ...
  },
  {
    ...
    level: null,
    requirements: [
      req("Introduce a prospective member to the Company and help them obtain Target Award"),
      req("Participate in the Recruitment Committee"),
    ],
  },
  // Interest — Group A
  {
  ...
  },
  {
    ...
    level: "Basic",
    requirements: [
      req("Learn a new skill as a hobby"),
      req("Submit a portfolio of at least 2 months of yourself practicing this hobby"),
    ],
  },
  {
    id: uid("b"),
  ...
  {
    id: uid("b"),
    name: "Enviromental Conservation",
    category: "adventure",
    level: "Basic",
    requirements: [
