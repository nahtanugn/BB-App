...
const KUCHING_SCHOOLS = [
  ...
  "SK Merpati Jepang", "SK Rancangan Perumahan Rakyat (RPR)", "SK Satria Jaya", "SK Laksamana", "SK Siol Kanan", "SK Tabuan Hilir", "SK Bandar Samariang", "SK Gita 2", "SK Muhibbah", "SK Encik Buyong", "SK Gersik", "SK Santubong", "SK Muara Tebas", "SK Pasir Pandak", "SK Gita", "SK Pulo", "SK Goebilt", "SK Tabuan", "SK Astana", "SK Tabuan Ulu", "SK Salak", "SK Semariang", "SK Tabuan Jaya", "SK Semerah Padi", "SK Rampang", "SK Maj. Gen. Datu Ibrahim", "SK Batu Lintang", "SK Pendidikan Khas (B) Kuching", "SK Jalan Ong Tian Swee", "SK Green Road", "SK Sungai Stutong", "SK Lumba Kuda", "SK Combined", "SK Buntal", "SK Bako", "SK Pajar Sejingkat", "SK Kampung Senari", "SK Matu Baru", "SK Rakyat", "SK Rakyat Tupong", "SK Madrasah Datuk Haji Abdul Kadir Hasan", "SK St Thomas (M)", "SK St Mary (M)", "SK St Joseph (M)", "SK St Teresa (M)", "SK St Theresa Padungan", "SK Catholic English (M)", "SK St Andrew (M)", "ST JOSEPH'S PRIVATE SECONDARY SCHOOL",
