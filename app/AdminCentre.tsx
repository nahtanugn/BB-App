              ...
              {readOnly ? (
                ...
                <form key={editingUser.id} onSubmit={updateUser}>
                  ...
                  {["admin", "officer"].includes(editingUser.role) && <div className="account-form-group"><p>Officer Section details</p><div className="account-field-grid">
                    ...
                    <label>Religion (optional)<select name="religion" defaultValue={editingUser.religion || ""}><option value="">Not recorded</option>{editingUser.religion && !religions.includes(editingUser.religion) && <option value={editingUser.religion}>{editingUser.religion} (existing)</option>}{religions.map((value) => <option key={value}>{value}</option>)}</select></label>
                    <label>Spiritual status (optional)<select name="spiritualStatus" defaultValue={editingUser.spiritual_status || ""}><option value="">Not recorded</option><option value="accepted_christ">Accepted Christ</option><option value="baptised">Baptised</option><option value="non_believer">Non-Believer</option></select></label>
                ...
                <form className="account-create-form" key={pendingAccountMember?.id ?? "new-admin-account"} onSubmit={createUser}>
                  ...
                  <div className="account-form-group">
                    ...
                    {["admin", "officer"].includes(newRole) && <div className="account-form-group"><p>Officer Section details</p><div className="account-field-grid">
                      ...
                      <label>Religion (optional)<select name="religion" defaultValue=""><option value="">Not recorded</option>{religions.map((value) => <option key={value}>{value}</option>)}</select></label>
                      <label>Spiritual status (optional)<select name="spiritualStatus" defaultValue=""><option value="">Not recorded</option><option value="accepted_christ">Accepted Christ</option><option value="baptised">Baptised</option><option value="non_believer">Non-Believer</option></select></label>
                    </div></div>}
