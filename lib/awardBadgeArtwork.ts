...
export const awardBadgeMetadata: Record<string, AwardBadgeMetadata> = Object.fromEntries([
  ...
  ["nco_proficiency", metadata("nco_proficiency", "left_arm_special", "special_row", 30, "special")],
  ["three_year_service", metadata("three_year_service", "left_arm_service", "service_upper", 30, "service")],
  ["long_year_service", metadata("long_year_service", "left_arm_service", "service_upper", 31, "service")],
